...
class Hand:
    ...
    def __str__(self):
        return f'your cards: {[card.__str__() for card in self.cards]}, value: {self.value}'
    ...
    while True:
        try:
            ...
            if chips.bet > chips.total:
                print('You can not risk more then you have')
            else:
                break
...
def hit_or_stand(deck, hand):
    ...
    while True:
        ...
        tobecont = input("Would you like to Hit or Stand? Enter 'h' or 's' ")

        if tobecont[0].lower() == 'h':
            hit(deck, hand)
        elif tobecont[0].lower() == 's':
...
# * The asterisk <code>*</code> symbol is used to print every
# item in a collection, and the <code>sep='\n '</code> argument prints
